		...
		case "EXPORT":
			...
			for (CourseSelection cs: sched.getCourseSelections()) {
				for (Activity a: cs.getActivities()) {
					...
					DateStart dateStart = new DateStart(startTime.getTime());
					dateStart.setTimezoneId("America/Toronto");
					event.setDateStart(dateStart);
					DateEnd dateEnd = new DateEnd(endTime.getTime());
					dateEnd.setTimezoneId("America/Toronto");
